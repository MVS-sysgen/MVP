...
/* RETURNS NOTHING */
  ...
  XMIJCL_STREAM = OPEN(JCL_LOCATION,'R')

  IF XMIJCL_STREAM < 0 THEN DO
    CALL ERROR "ERROR READING "||JCL_LOCATION||":" XMIJCL_STREAM
    EXIT 8
  END

  XMIJCL.0 = LINES(XMIJCL_STREAM)    
  DO K=1 TO LINES(XMIJCL_STREAM)
    XMIJCL.K = LINEIN(XMIJCL_STREAM) 
  END 
  
  CALL CLOSE XMIJCL_STREAM                      
